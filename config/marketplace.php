...
return [
    ...
    */
    'homepage_category_images' => [
        ...
        'groceries' => 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=400&h=400&q=80',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Health Services demo profiles (deprecated)
    |--------------------------------------------------------------------------
    |
    | Previously used as a UI fallback when no DB professionals existed.
    | Listings now come only from approved health_professionals records.
    |
    */
